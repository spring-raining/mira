...
const markdownStyling = css`
  ...
  * {
    font-family: ${cssVar('fonts.body')};
    color: ${cssVar('colors.gray.800')};
    line-height: 1.5;
    border-width: 0;
    border-style: solid;
  ...
  h5,
  h6 {
    font-family: ${cssVar('fonts.heading')};
    font-weight: 700;
    margin-top: 1rem;
    margin-bottom: 1rem;
  }
  ...
  th {
    ...
    line-height: 1rem;
    font-size: 0.75rem;
    color: ${cssVar('colors.gray.600')};
    border-bottom: 1px solid;
    border-color: ${cssVar('colors.gray.100')};
  }
  tr:last-of-type th {
